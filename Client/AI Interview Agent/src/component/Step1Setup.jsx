            ...
            >
                ...
                <div className='space-y-6'>
                    <div className='relative'>
                        <FaUserTie className='absolute top-4 left-5 text-gray-400' />
                    ...
                    <div className='relative'>
                        <FaBriefcase className='absolute top-4 left-5 text-gray-400' />
                    ...
                    {analysisDone && (
                        ...
                        className='bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4 max-h-[200px] overflow-auto'>
                            ...
                            {skills.length > 0 && (
                                <div>
                                    ...
                                    <ul className='flex flex-wrap gap-2'>
                                        {skills.map((s, i) => (
                                            <li className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm' key={i}>{s}</li>
                                        ))}
                                    </ul>
                                </div>
                            )}    
