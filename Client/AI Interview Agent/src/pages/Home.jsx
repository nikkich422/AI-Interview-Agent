      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
          <motion.h1 className='text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto'>
            Practive Interview with
            <span className='relative inline-block mt-[30px] mb-[10px]'>
          ...
          <motion.p 
            ...
            className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
              Role-based mock interviews with smart follow-ups, adaptive difficulty and real-time performance evaluation. Get detailed feedback and insights to improve your interview skills and boost your confidence.
          </motion.p>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                },
                {
                  ...
                  <motion.div key={item.step} className={`
